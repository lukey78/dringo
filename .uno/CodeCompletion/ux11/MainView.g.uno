...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public Template(MainView parent, MainView parentInstance): base("welcome", false)
        {
            __parent = parent;
        ...
        {
            var __self = new global::WelcomePage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "welcome";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("dashboard", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::DashboardPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("locationList", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::LocationListPage(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "locationList";
    }
    ...
    void InitializeUX()
    {
        ...
        var welcome = new Template(this, this);
        var dashboard = new Template1(this, this);
        var locationList = new Template2(this, this);
        ...
        temp19.DefaultPath = "welcome";
        temp19.Templates.Add(welcome);
        temp19.Templates.Add(dashboard);
        temp19.Templates.Add(locationList);
